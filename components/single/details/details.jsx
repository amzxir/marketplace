                        ...
                        <div class="col-md-6 mb-5">
                            <div class="banner banner-video product-video br-xs">
                                <figure class="banner-media">
                                    <a href="#">
                                        <Image src="/assets/images/products/video-banner-610x300.jpg"
                                            alt="banner" width="610" height="300" style={{ backgroundColor:'#bebebe' }}/>
                                    </a>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-4">
                            <figure class="vendor-banner br-sm">
                                <Image src="/assets/images/products/vendor-banner.jpg"
                                    alt="Vendor Banner" width="610" height="295" style={{ backgroundColor:'#353B55' }} />
                            </figure>
                        </div>
                        <div class="col-md-6 pl-2 pl-md-6 mb-4">
                            <div class="vendor-user">
                                <figure class="vendor-logo mr-4">
                                    <a href="#">
                                        <Image src="/assets/images/products/vendor-logo.jpg"
                            ...
                            <div class="tab-pane active" id="show-all">
                                <ul class="comments list-style-none">
                                    <li class="comment">
                                        <div class="comment-body">
                                            <figure class="comment-avatar">
                                                <Image src="/assets/images/agents/1-100x100.png"
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <div class="comment-action">
                                                    ...
                                                    <div class="review-image">
                                                        <a href="#">
                                                            <figure>
                                                                <Image src="/assets/images/products/default/review-img-1.jpg"
                                                                    width="60" height="60"
                                    ...
                                    <li class="comment">
                                        <div class="comment-body">
                                            <figure class="comment-avatar">
                                                <Image src="/assets/images/agents/2-100x100.png"
                                                    alt="Commenter Avatar" width="90" height="90"/>
                                            </figure>
                                            <div class="comment-content">
                                                <h4 class="comment-author">
                                                ...
                                                <div class="comment-action">
                                                    ...
                                                    <div class="review-image">
                                                        <a href="#">
                                                            <figure>
                                                                <Image src="/assets/images/products/default/review-img-2.jpg"
                                                                    width="60" height="60"
                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                        ...
                                                        <a href="#">
                                                            <figure>
                                                                <Image src="/assets/images/products/default/review-img-3.jpg"
                                                                    width="60" height="60"
                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                    ...
                                    <li class="comment">
                                        <div class="comment-body">
                                            <figure class="comment-avatar">
                                                <Image src="/assets/images/agents/3-100x100.png"
                                                    alt="Commenter Avatar" width="90" height="90"/>
                                            </figure>
                                            <div class="comment-content">
                                                <h4 class="comment-author">
