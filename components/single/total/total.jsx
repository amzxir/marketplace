          ...
          <div class="bought-together-products row mt-8 pb-4">
              <div class="product product-wrap text-center">
                  <figure class="product-media">
                      <Image src="/assets/images/products/default/bought-1.jpg" alt="Product"
              ...
              <div class="product product-wrap text-center">
                  <figure class="product-media">
                      <Image src="/assets/images/products/default/bought-2.jpg" alt="Product"
                          width="138" height="138" />
                      <div class="product-checkbox">
              ...
              <div class="product product-wrap text-center">
                  <figure class="product-media">
                      <Image src="/assets/images/products/default/bought-3.jpg" alt="Product"
                          width="138" height="138" />
                      <div class="product-checkbox">
