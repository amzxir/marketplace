...
export default function Footer() {
  return (
    <>
      <footer className="footer footer-dark appear-animate mt-10">
                  ...
                  <div className="row">
                      <div className="col-lg-4 col-sm-6">
                          <div className="widget widget-about">
                              <a href="demo9.html" className="logo-footer">
                                  <img src="assets/images/demos/demo9/footer-logo.png" alt="logo-footer" width="144"
                                      height="45" />
                              </a>
