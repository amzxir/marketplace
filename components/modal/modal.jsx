...
export default function Modal({children , show}) {
  ...
  return (
    <>
        ...
        <div className={`top-0 right-0 left-0 bottom-0 fixed bg-white w-[75%] m-auto h-[75%] z-40 p-10 ${show ? 'translate-y-0 opacity-1' :'translate-y-full opacity-0'} ease-in-out duration-300`}>
